...
if updatePaths:
	...
	print(time.ctime())
	print()
	diskStat = fx.parallelFindData(data_directories, split=split_directories, rmDir=rm_directories)
...
if updatePaths:
	...
	print(time.ctime())
	print()
	fx.updateDatabaseHoldings(sqlDB, diskPaths, diskStat, dbPaths, db, invalidPaths, retiredPaths)
